                        ...
                        AspectRatio(
                          ...
                          child: ClipRRect(
                            ...
                            child: CarouselSlider(
                              ...
                              items:
                                  state.offerCarouselImages.map((carousalItem) {
                                    return Builder(
                                                  ...
                                                  child: Align(
                                                    ...
                                                    child: Container(
                                                      width:
                                                          ...
                                                          (2 *
                                                              0.85), // half of the carousel item width (0.85 viewportFraction)
                                                      padding:
                ...
                SliverPadding(
                  ...
                  sliver: SliverGrid.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      // Check if the index is within the actual image list bounds
                      if (index < state.imageUrls.length) {
                        ...
                        // Return an empty container or a placeholder for the extra tiles
                        return Container();
                      }
                    },
                  ),
